...
export const products: Record<ProductSlug, SiteProduct> = {
  xtreme: {
    ...
    gallery: ["/volt-lab/products/xtreme_transparent.png", "/volt-lab/source/xtreme_product.webp"],
    priceAmount: 4499,
    ...
    keyFeatures: ["High-output 96V architecture", "Off-road focused power delivery", "Serviceable modular components", "COWIN support path"],
    variants: [
      { id: "xtreme-96v-standard", label: "96V Standard", sku: "CW-XT-96V-STD", options: { Voltage: "96V", Color: "Factory Black" }, inventory: 12 },
    ],
    inventory: 12,
  ...
  xceed: {
    ...
    gallery: ["/volt-lab/products/xceed_transparent.png", "/volt-lab/source/xceed_product.webp"],
    priceAmount: 3099,
    sku: "CW-XC-72V",
    model: "XCEED 72V",
    brand: "COWIN",
    ...
    variants: [
      { id: "xceed-72v-black", label: "72V Black", sku: "CW-XC-72V-BLK", options: { Voltage: "72V", Color: "Black" }, inventory: 18 },
      { id: "xceed-72v-orange", label: "72V Blaze Orange", sku: "CW-XC-72V-ORG", options: { Voltage: "72V", Color: "Blaze Orange" }, inventory: 8, image: "/volt-lab/category/dirt-bikes/dirt_bikes_use_product_card_03.png" },
    ],
    inventory: 26,
    stockStatus: "in_stock",
  ...
  xcite: {
    ...
    gallery: ["/volt-lab/products/xcite_transparent.png", "/volt-lab/source/xcite_product.webp"],
    priceAmount: 499,
    sku: "CW-EB-XCITE",
    ...
    variants: [{ id: "xcite-standard", label: "Standard", sku: "CW-EB-XCITE-STD", options: { Frame: "Step-Thru" }, inventory: 32 }],
    inventory: 32,
    stockStatus: "in_stock",
  ...
  xplore: {
    ...
    gallery: ["/volt-lab/products/xplore_transparent.png", "/volt-lab/source/xplore_product.webp"],
    priceAmount: 499,
    sku: "CW-EB-XPLORE",
    ...
    variants: [{ id: "xplore-standard", label: "Standard", sku: "CW-EB-XPLORE-STD", options: { Frame: "Utility" }, inventory: 24 }],
    inventory: 24,
    stockStatus: "in_stock",
  ...
  xplus: {
    ...
    gallery: ["/volt-lab/products/xplus_transparent.png", "/volt-lab/source/xplus_product.webp"],
    priceAmount: 599,
    sku: "CW-EB-XPLUS",
    ...
    variants: [{ id: "xplus-standard", label: "Standard", sku: "CW-EB-XPLUS-STD", options: { Comfort: "Full Suspension" }, inventory: 20 }],
    inventory: 20,
    stockStatus: "in_stock",
  ...
  "smart-b02": {
    ...
    gallery: ["/volt-lab/products/smart_b02_transparent.png", "/volt-lab/source/smart_b02_product.webp"],
    priceAmount: 399,
    sku: "CW-SMART-B02",
    model: "SMART B02",
    brand: "COWIN",
    ...
    variants: [{ id: "smart-b02-standard", label: "Standard", sku: "CW-SMART-B02-STD", options: { Model: "B02" }, inventory: 16 }],
    inventory: 16,
    stockStatus: "in_stock",
  ...
  "battery-pack": {
    ...
    image: "/media/accessories/x-series-battery.jpg",
    gallery: ["/media/accessories/x-series-battery.jpg"],
    priceAmount: 1199,
    sku: "CW-ACC-BATTERY",
    model: "X Series Battery Pack",
    brand: "COWIN",
    shortDescription: "Genuine replacement battery pack for compatible X Series platforms.",
    description: "This battery pack supports compatible COWIN X Series products and is intended for genuine replacement or service workflows.",
    ...
    keyFeatures: ["Genuine COWIN part", "Compatible X Series fit", "Service support path"],
    variants: [{ id: "battery-pack-standard", label: "Standard", sku: "CW-ACC-BATTERY-STD", options: { Package: "Battery Pack" }, inventory: 10 }],
    inventory: 10,
    stockStatus: "in_stock",
  ...
  "brake-kit": {
    ...
    categorySlug: "accessories",
    categoryPath: "/accessories",
    image: "/media/accessories/xceed-brake-kit.jpg",
    gallery: ["/media/accessories/xceed-brake-kit.jpg"],
    priceAmount: 49,
    sku: "CW-ACC-BRAKE-KIT",
    ...
    variants: [{ id: "brake-kit-standard", label: "Standard", sku: "CW-ACC-BRAKE-KIT-STD", options: { Package: "Brake Kit" }, inventory: 40 }],
    inventory: 40,
    stockStatus: "in_stock",
  ...
  "smart-charger": {
    ...
    categorySlug: "accessories",
    categoryPath: "/accessories",
    image: "/media/accessories/xceed-fast-charger.jpg",
    gallery: ["/media/accessories/xceed-fast-charger.jpg"],
    priceAmount: 249,
    sku: "CW-ACC-CHARGER",
    model: "Smart Fast Charger",
    brand: "COWIN",
    shortDescription: "Smart charger accessory for compatible COWIN electric platforms.",
    description: "The Smart Fast Charger supports compatible COWIN platforms with a clear charging accessory path for service and ownership.",
    specs: ["Fast charge", "Smart protection", "X series", "Travel ready"],
    specifications: [{ label: "Part Type", value: "Smart charger", group: "Build" }, { label: "Compatibility", value: "Compatible COWIN platforms", group: "Fitment" }],
    keyFeatures: ["Smart protection workflow", "Compatible platform accessory", "Compact charging support"],
    variants: [{ id: "smart-charger-us", label: "US Plug", sku: "CW-ACC-CHARGER-US", options: { Plug: "US" }, inventory: 36 }],
    inventory: 36,
    stockStatus: "in_stock",
