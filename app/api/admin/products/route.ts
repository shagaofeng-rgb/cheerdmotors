...
export async function POST(request: Request) {
  ...
  await writeAdminStore((store) => {
    ...
    const product: AdminProduct = {
      ...
      coverImage: text(formData, "coverImage", 260) || "/volt-lab/products/xceed_transparent.png",
      ...
      currency: "USD",
      sku: text(formData, "sku", 100) || `CM-${slug.toUpperCase()}`,
      ...
      seoTitle: text(formData, "seoTitle", 180) || `${name} | CHEERDMOTO`,
