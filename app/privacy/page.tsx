...
export const metadata: Metadata = {
  title: "Privacy Policy | COWIN",
  description: "How COWIN collects, uses, stores, and protects customer inquiry, order, and website analytics data.",
  ...
  return (
    <main className="content-page legal-page">
      ...
      <section className="content-body">
        ...
        <p>COWIN collects information that customers submit through inquiry forms, contact forms, checkout flows, newsletter subscriptions, and support requests. This may include name, email, phone number, company, country, product interest, shipping details, and message content.</p>
        ...
        <h2>Data Storage</h2>
        <p>Customer, order, content, media, and analytics data may be stored in secure cloud services connected to the COWIN website. Access is limited to authorized administrators.</p>
        ...
        <h2>Contact</h2>
        <p>For privacy requests, contact us through the website contact page or the published COWIN support email.</p>
      </section>
    </main>
  );
}
